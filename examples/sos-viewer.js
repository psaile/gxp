...
Ext.onReady(function() {
    app = new gxp.Viewer({
        ...
        sources: {
            ...
            sos: {
                ptype: "gxp_sossource",
                url:"http://pegelonline.wsv.de/webservices/gis/gdi-sos"
            }
        },
        ...
        map: {
            ...
            layers: [{
                source: "sos",
                name: "sos",
                title: "Pegelonline Sensor Obserbation Service"
            }, {
                source: "ol",
                ...
                source: "local",
                name: "gwsp:map39_mean_annual_river_discharge_raster",
                title: "Annual River discharge",
                queryable: true,
